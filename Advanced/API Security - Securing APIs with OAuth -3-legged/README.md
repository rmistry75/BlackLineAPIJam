...
* You have an API proxy in Apigee Edge. If not, jump back to *API Design : Create a Reverse Proxy with OpenAPI Specification* lab.
...
* Download the pre-built OAuth proxy bundle from [here](https://github.com/apigee/apijam/blob/master/Resources/xx_oauth_code_grant.zip) 
